      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="font-display text-xs uppercase tracking-[0.2em] text-cream/60 mt-1">
                Carnes Ahumadas
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <span className="font-body text-sm text-cream/70 leading-snug">
                {t("contact.address")}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <Phone size={18} className="text-gold mt-0.5 flex-shrink-0 group-hover:scale-110 transition-transform" />
                  <div>
                    <span className="block font-body text-sm text-cream font-medium">{t("contact.phone")}</span>
                    <span className="block font-body text-xs text-cream/50 group-hover:text-gold transition-colors">
                      {t("contact.whatsapp")}
                    </span>
                  </div>
                </a>
              ...
              <li>
                <a 
                  ...
                  className="flex items-start gap-3 group"
                >
                  <Mail size={18} className="text-gold mt-0.5 flex-shrink-0 group-hover:scale-110 transition-transform" />
                  <span className="font-body text-sm text-cream/70 group-hover:text-gold transition-colors break-all">
                    {t("contact.email")}
                  </span>
                </a>
              </li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-4">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="group flex flex-col sm:flex-row items-center gap-4 transition-opacity hover:opacity-80"
          >
            <span className="font-display text-[10px] uppercase tracking-widest text-cream/50 group-hover:text-gold transition-colors text-center sm:text-right">
              {t("designedBy")}<br />
            ...
            <div className="w-32 h-32 md:w-40 md:h-40 flex-shrink-0 transition-transform group-hover:scale-105 duration-300">
              <svg 
                ...
                aria-label="Logo de Temozonia Carnes Ahumadas - Desarrollado por AceptaBitcoin.org"
              >
                <defs>
                  <style>
                    {`
                  ...
                  <radialGradient id="smoke-gold" cx="50%" cy="80%" r="70%">
                    ...
                    <stop offset="50%" stop-color="#D4AF37" stop-opacity="0.6" />
                    <stop offset="100%" stop-color="#8B1E1E" stop-opacity="0" />
                  </radialGradient>
                ...
                <g>
                  ...
                  <circle cx="500" cy="500" r="440" fill="none" stroke="#8B1E1E" stroke-width="16" />
                  <circle cx="500" cy="500" r="418" fill="none" stroke="url(#gold-gradient)" stroke-width="4" />
                </g>
                <g id="horno-emblema">
                  ...
                  <path d="M 450 185 H 550 M 450 210 H 550 M 450 235 H 550 M 500 160 V 185 M 475 185 V 210 M 525 185 V 210 M 500 210 V 235" stroke="#F9F3E9" stroke-width="2" opacity="0.4" />
                  <rect x="270" y="270" width="460" height="230" fill="url(#brick-gradient)" rx="6" />
                  <rect x="260" y="260" width="480" height="20" fill="#7E1D0F" rx="3" />
                  <g stroke="#F9F3E9" stroke-width="2.5" opacity="0.35" fill="none">
                  ...
                  <path d="M 315 500 A 185 185 0 0 1 685 500" fill="none" stroke="#7E1D0F" stroke-width="35" />
                  <path d="M 300 500 A 200 200 0 0 1 700 500" fill="none" stroke="url(#gold-gradient)" stroke-width="3" />
                  <g filter="url(#glass-shadow)">
                    <path d="M 350 500 A 150 150 0 0 1 650 500 Z" fill="#1A0D05" />
                    <text x="500" y="445" text-anchor="middle" className="brand-year">DESDE</text>
                    <text x="500" y="480" text-anchor="middle" className="brand-year" fontSize="32" fontWeight="bold">2013</text>
